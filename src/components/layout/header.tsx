...
const NAV_LINKS = [
  ...
  { label: "Jewellery for Her", href: "/shop?gender=WOMEN" },
  { label: "Jewellery for Him", href: "/shop?gender=MEN" },
  { label: "Brands", href: "/shop" },
  { label: "New Arrivals", href: "/shop?sort=newest" },
  { label: "Sale", href: "/shop?onSale=1", sale: true },
];
      ...
      >
        <div className="container-tc">
          <div className="flex h-16 items-center justify-between gap-4 md:h-[4.5rem]">
            ...
            {/* Logo */}
            <Link href="/" className="shrink-0 py-1" aria-label="Corals by Tabassum home">
              <Logo />
            </Link>
