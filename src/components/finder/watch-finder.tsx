...
const QUESTIONS: Question[] = [
  {
    key: "gender",
    question: "Who is the piece for?",
    emoji: "🙋",
    options: [
      { value: "MEN", label: "Men", hint: "Bold, masculine designs", emoji: "🤵" },
      { value: "WOMEN", label: "Women", hint: "Elegant, feminine pieces", emoji: "👩" },
      { value: "UNISEX", label: "Unisex / Any", hint: "Versatile styling", emoji: "🤝" },
    ],
  },
  {
    key: "budget",
    ...
    options: [
      ...
      { value: "60000+", label: "Above Rs. 60,000", hint: "Bridal & statement", emoji: "💎" },
    ],
  },
  {
    key: "style",
    ...
    emoji: "✨",
    options: [
      { value: "daily wear", label: "Daily Wear", hint: "Easy, all-day pieces", emoji: "☕" },
      { value: "party wear", label: "Party Wear", hint: "Glossy & dressy", emoji: "🥂" },
      { value: "bridal", label: "Bridal", hint: "Rich kundan couture", emoji: "💍" },
  ...
  },
  {
    ...
    emoji: "✨",
    options: [
      { value: "gold plated", label: "Gold Plated", hint: "Warm, classic gold", emoji: "🟡" },
      { value: "rose gold", label: "Rose Gold", hint: "Soft, feminine blush", emoji: "🌹" },
      { value: "925 silver", label: "925 Silver", hint: "Cool, bright silver", emoji: "⚪" },
      { value: "kundan", label: "Kundan", hint: "Traditional stonework", emoji: "💠" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "formal", label: "Work & office", hint: "Smart, understated", emoji: "💼" },
      { value: "party", label: "Parties & events", hint: "Cocktails & dinners", emoji: "🥂" },
      { value: "wedding", label: "Weddings", hint: "Bridal occasions", emoji: "💐" },
    ],
  },
];
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-heading text-2xl text-obsidian lg:text-3xl">
                {results.length > 0
                  ? `${results.length} piece${results.length === 1 ? "" : "s"} chosen for you`
                  : "No exact matches"}
              </h2>
            </div>
          ...
          {results.length === 0 ? (
            <div className="mt-8 rounded-xl border border-dashed border-soft-gray p-12 text-center">
              <p className="text-sm text-text-gray">
                We couldn't find a piece matching all criteria. Try loosening
