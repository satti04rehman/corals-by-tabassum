...
const FAQS = [
  {
    ...
    a: "Browse our collection, add pieces to your bag, and checkout with Cash on Delivery or Bank Transfer. Your order is confirmed instantly and our team calls you to verify delivery details.",
  },
  {
  ...
  },
  {
    ...
    a: "We offer a 7-day hassle-free return window after delivery for unworn pieces in original packaging. Refunds follow your original payment method.",
  },
  {
    q: "Are the pieces genuine?",
    a: "Absolutely. Every piece we sell is 100% handcrafted and quality-checked before dispatch.",
  },
  {
  ...
  },
  {
    ...
    a: "Add the piece to your wishlist and we'll notify you as soon as it's back in stock.",
  },
];
