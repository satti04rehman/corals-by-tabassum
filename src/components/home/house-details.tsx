import { Gem, Truck, Users, ShieldCheck, HeadphonesIcon } from "lucide-react";
import { Reveal } from "@/components/ui/reveal";
import { CountUp } from "@/components/ui/count-up";

const STATS = [
  { icon: Gem, value: "10+", label: "Premium Brands" },
  { icon: Gem, value: "8", label: "Curated Categories" },
...
const FEATURES = [
  {
    icon: Gem,
    title: "Craftsmanship",
    text: "Handcrafted gold-plated and kundan pieces, finished by skilled artisans to last generations.",
  },
  {
    icon: ShieldCheck,
    title: "Authenticity",
    text: "Every piece is hand-checked and quality-certified before it reaches your doorstep.",
  },
  {
    icon: HeadphonesIcon,
    title: "Customer Care",
