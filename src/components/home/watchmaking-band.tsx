...
/**
 * Full-bleed cinematic brand band: dark imagery with a small centered
 * editorial block and an underline link.
 */
  ...
  return (
    <section className="relative flex min-h-[72vh] items-center justify-center overflow-hidden bg-obsidian">
      <div className="absolute inset-0">
        <Image
          src="/images/products/kundan-set.jpg"
          alt=""
          fill
          priority
          sizes="100vw"
      ...
      <div className="relative z-10 px-6 text-center text-ivory">
        <Reveal>
          ...
          <p className="mx-auto mt-6 max-w-xl text-sm font-light leading-relaxed tracking-wide text-ivory/75 sm:text-base">
            Every piece in our collection is chosen for its craft, finish and
            character &mdash; from delicate gold plating to rich kundan work.
          </p>
          <Link
            href="/shop"
