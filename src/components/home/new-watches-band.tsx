...
/**
 * Black editorial band ("New arrivals 2026" style): uppercase headline,
        ...
        <Reveal>
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <Link
              ...
              className="group inline-flex items-center gap-3 border-b border-ivory/50 pt-4 pb-3 text-xs font-medium uppercase tracking-[0.35em] text-ivory transition-colors hover:border-champagne hover:text-champagne"
            >
              The Corals by Tabassum collection
