        ...
        <div className="prose prose-neutral max-w-3xl text-text-gray">
          {description ? (
            ...
            <p className="leading-relaxed">
              A timeless piece handcrafted with care and attention to detail.
              Each design is selected for its quality, elegance and everyday
              wearability — made to be worn to every occasion and treasured
              for years.
            </p>
          )}
        </div>
        ...
        <div className="grid max-w-4xl gap-8 lg:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-6">
            <div className="flex justify-end">
              <ReviewForm
                productId={productId}
                productName={productName ?? "this piece"}
...
const fallbackSpecs: { label: string; value: string }[] = [
  { label: "Brand", value: "Corals by Tabassum" },
  { label: "Metal", value: "Gold Plated" },
  { label: "Gemstone", value: "Polish Finish" },
