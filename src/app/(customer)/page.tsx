  ...
  return (
    <>
      ...
      <section className="bg-white">
        <div className="container-tc py-16 lg:py-24">
          <SectionHeader
            ...
            title="Best Sellers"
            subtitle="The pieces everyone can't stop talking about."
      ...
      <section className="border-t border-soft-gray bg-white">
        <div className="container-tc py-16 lg:py-24">
          <SectionHeader
            eyebrow="Step into the world of Corals by Tabassum"
            title="Partners in Style"
            subtitle="From everyday classics to statement pieces, every piece is chosen with care."
          />
          <Reveal className="mt-10">
