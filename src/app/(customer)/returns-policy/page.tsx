  ...
  return (
    ...
    >
      <PolicySection heading="7-Day Returns">
        <p>
          We want you to love your piece. If it is not what you expected, you
      ...
      <PolicySection heading="Return Conditions">
        <p>
          To be eligible for a return, the piece must be unused, unworn, and
          in its original packaging with all tags and accessories intact.
        </p>
      </PolicySection>
      ...
      <PolicySection heading="How to Start a Return">
        <p>
          ...
          3. The piece is inspected on arrival at our facility.<br />
      ...
      <PolicySection heading="Refund Method">
        <p>
          ...
          account. Quality and after-sales issues are handled directly by our
          team.
        </p>
      </PolicySection>
    </PolicyShell>
