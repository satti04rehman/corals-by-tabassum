...
export async function getPopularQueries(): Promise<string[]> {
  const ready = await isDbReady();
  if (!ready) {
    return ["Ameera", "Zoya", "Gold Plated", "Kundan", "Rings"];
  }
  void ready;
  return ["Ameera", "Zoya", "Gold Plated", "Kundan", "Bridal Jewellery"];
}
...
export async function getPage(slug: string) {
  ...
  if (!ready) {
    const content: Record<string, { title: string; content: string }> = {
      "about-us": {
        title: "About Corals by Tabassum",
        content:
          "Corals by Tabassum is a modern destination for jewellery — combining timeless design with a simple, trustworthy shopping experience.<br/><br/>We offer authentic pieces, handcrafted with care and delivered to your doorstep with secure payment and easy returns.<br/><br/><strong>Elegance meets everyday.</strong>",
      },
      "shipping-policy": {
      ...
      "return-policy": {
        ...
        content:
          "We offer a 7-day easy return window on all unworn pieces in their original packaging.<br/><br/>To initiate a return, contact our support team within 7 days of delivery. Refunds are processed within 5–7 working days after inspection.",
      },
      "warranty-policy": {
        title: "Warranty Policy",
        content:
          "Every piece purchased from Corals by Tabassum is covered by a quality guarantee.<br/><br/>This covers manufacturing defects and craftsmanship issues. It does not cover damage caused by normal wear, accidents or improper storage.",
      },
      "privacy-policy": {
      ...
      "terms-and-conditions": {
        ...
        content:
          "By using Corals by Tabassum you agree to the following terms. All prices listed are in Pakistani Rupees (PKR) and include applicable taxes unless stated otherwise.<br/><br/>We reserve the right to refuse or cancel orders in cases of suspected fraud or pricing errors.",
      },
      faq: {
        title: "Frequently Asked Questions",
        content:
          "<strong>Q: How long does delivery take?</strong><br/>Standard delivery takes 3–5 working days, express takes 1–2 working days.<br/><br/><strong>Q: Are the pieces authentic?</strong><br/>Yes. Every piece is handcrafted with care and quality-checked before dispatch.<br/><br/><strong>Q: Can I pay on delivery?</strong><br/>Absolutely. Cash on Delivery is available nationwide.<br/><br/><strong>Q: What is your return policy?</strong><br/>7-day easy returns on unworn pieces in original condition.",
      },
    };
...
export function getPromoBanner() {
  return {
    title: "Up to 30% OFF Selected Jewellery",
    subtitle: "A timeless piece, now at a special price.",
    cta: "Shop the Sale",
    href: "/shop?s=discount",
  };
}